...
namespace LoginApp.Controllers
{
    ...
    public class RegistrationController : ControllerBase
    {
        ...
        public RegistrationController(IConfiguration configuration, IGoogleRecaptchaService googleRecaptchaService)
        {
        ...
        [HttpPost]
        [Route("verify")]
        public async Task<IActionResult> VerifyRecaptcha([FromBody] RecaptchaToken token)
        {
            var result = await _googleRecaptchaService.VerifyToken(token.Token);
